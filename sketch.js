...
function setup() {
  ...
  ground = createSprite(displayWidth/2 ,camera.position.y+100,displayWidth+1500,10);
  ground.addImage("ground",groundImage);
  ground.scale=2
  ground.x = ground.width /2;
  ground.velocityX = -4;
  
  invisibleGround = createSprite(displayWidth/2 ,camera.position.y+100,displayWidth,10);
...
function draw() {
  ...
  if(keyDown("space")&& trex.y >= displayHeight/2) {
    trex.velocityY = -15;
  }
...
function spawnObstacles() {
  if(frameCount % 80 === 0) {
    var obstacle = createSprite(displayWidth/2 +500,camera.position.y+90,displayWidth,10);
